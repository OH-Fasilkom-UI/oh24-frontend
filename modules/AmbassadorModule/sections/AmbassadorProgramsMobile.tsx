        ...
        {AMBASSADOR_PROGRAMS.map((program, index) => (
          <div className="flex max-md:w-[280px] font-bold md:w-[524px] flex-col lg:flex-row lg:flex-wrap bg-gradient-custom pb-5 rounded-[50px]">
            <Card
              key={index}
              title=""
              className="h-full px-10 flex flex-col font-riffic leading-7 font-bold mx-auto md:w-[524px] shadow-timeline text-white rounded-[50px] mb-1 lg:mb-0 lg:mr-auto"
            >
