...
export interface ContactPersonProps extends React.HTMLAttributes<HTMLDivElement> {
                ...
                <div className="flex flex-col gap-8 h-fit w-fit justify-center">
                    <div className="w-full flex flex-col gap-8 justify-center items-center">
                        <div className="flex flex-col gap-2 text-white">
                            <h5 className="font-riffic font-bold text-2xl leading-8 text-center">Butuh bantuan atau memiliki pertanyaan?</h5>
                        ...
                        {/* Buttons Stored Here */}
                        <div className={`${children ? "flex" : "hidden"} flex-col md:flex-row justify-center lg:justify-start w-full gap-4`}>
                            {children}
                        </div>
                    </div>
