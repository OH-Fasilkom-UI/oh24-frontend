                    ...
                    <div className="flex gap-10 lg:gap-16 xl:gap-32 font-tex-gyre font-bold text-white justify-end">
                        <div className="flex flex-col gap-4 md:gap-8 text-xl ">
                            <div className="flex flex-col items-end md:items-start gap-4">
                                <h5 className="text-right md:text-left text-xs md:text-xl">Find Us on Social Media</h5>
                                <div className="flex gap-3 lg:gap-9 items-center cursor-pointer">
                                    ...
                                    <a href="">
                                        <Youtube className="w-4 lg:w-10 cursor-pointer" fill="white"/>
                                    </a>
                                    <a href="">
                                        <Image
                                            src={'/tiktok.svg'}
                            ...
                            <div className="flex flex-col items-end md:items-start">
                                ...
                                <div className="flex gap-2 items-center">
                                    <span className="font-normal text-xs flex md:text-base">openhouse@cs.ui.ac.id</span>
                                    <Copy
                                        onClick={() => {
                                            // Copy to clipboard
