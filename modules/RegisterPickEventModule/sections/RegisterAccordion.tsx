...
export const EventFAQAccordion = [
    {
        question: "Kak, aku ingin merasakan pengalaman offline tour di Fasilkom! Pilih yang mana ya?",
        answer:
    ...
    {
        question: "Kak, aku belum bisa hadir secara offline nih.. Tapi kepengen ikutan :(",
        answer:
...
const RegisterAccordion = () => {
    return (
        <div className="w-full h-[70vh] max-lg:h-[50vh] mt-[45rem] max-lg:mt-[8rem] flex flex-col items-center">
            <h1 className='text-[#B91B70] text-t3 max-lg:text-t4 max-md:text-t5 mb-16 text-center w-[83vw]'>Masih bingung mau pilih opsi yang mana? 🤔</h1>
            <Accordion type="single" collapsible className="flex flex-col lg:gap-4 z-20 w-[83vw]">
